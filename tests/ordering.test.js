...
const { newRecentMistakesFirstSorter } = require('../src/recentMistakes.js');
const { newMostMistakesFirstSorter } = require('../src/mostMistakes.js');
const { newCardStatus } = require('../src/cards/cardstatus.js');
const { newFlashCard } = require('../src/cards/flashcard.js');
...
describe('Test prioritization', () => {
  ...
  test('Test newMostMistakesFirstSorter', () => {
    const cardsSorted = newMostMistakesFirstSorter().reorganize(cards);
  ...
  test('Test recentMistakesFirstSorter', () => {
    const cardsSorted = newRecentMistakesFirstSorter().reorganize(cards);
    expect(cardsSorted[0]).toEqual(cardStatus1);
